...
## 3. Zone 1: The Environmental Conflict (Invisible UI Baseline)
...
## 4. Zone 2: Input-Output Decoupling (The Ghost Touch)
...
## 5. Zone 3: The Ghost in the Machine (Remote C2 Mirror)
