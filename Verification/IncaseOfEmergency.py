...
InCaseOfEmergency.py - Ran against a production logdata.LiveData.tracev3
...
```
tracev3 = Path('logdata.LiveData.tracev3')
if not tracev3.exists():
    print(f"❌ logdata.LiveData.tracev3 not found.")
    print(f"   Place the file in: {tracev3.resolve().parent}")
    return False

with open(tracev3, 'rb') as f:
    data = f.read()
